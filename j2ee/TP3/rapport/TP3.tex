...
Le principal problème est lié au fait que nous utilisons une classe définie. Si l'on décide de créer un nouveau DAO, il faudra modifier le code en conséquence.
